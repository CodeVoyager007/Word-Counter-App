...
export default function WordCounter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen gap-6 bg-black text-white">
      <Card className="w-full max-w-md bg-white text-black">
        ...
        <CardContent className="space-y-4">
          ...
          <Textarea
            ...
            className="h-32 resize-none bg-white text-black"
            value={text}
          ...
          <div className="flex items-center justify-between">
            ...
            <Button onClick={clearText} className="bg-black text-white">
              Clear
            </Button>
          </div>
        </CardContent>
      ...
      {/* Tagline in the bottom right corner */}
      <div className="absolute bottom-4 right-4 text-sm text-white italic">
        Made with <span style={{ color: '#AA0000' }}>♥</span> by Ayesha Mughal
      </div>
    </div>
  );
}
